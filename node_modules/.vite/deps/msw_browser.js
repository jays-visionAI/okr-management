...
var _listeners, _listenerOptions, _typelessListeners, _hookListeners, _hookListenerOptions, _Emitter2_instances, addListener_fn, proxyEvent_fn, callListener_fn, matchListeners_fn, isTypelessListener_fn, _a8;
  ...
  */
  removeAllListeners(type) {
    ...
    if (type == null) {
      ...
      for (const [hookType, hookListener] of __privateGet(this, _hookListeners)) if (!((_a15 = __privateGet(this, _hookListenerOptions).get(hookListener)) == null ? void 0 : _a15.persist)) __privateGet(this, _hookListeners).delete(hookType, hookListener);
      return;
    }
